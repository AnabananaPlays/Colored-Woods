execute at @s as @s if block ~ ~ ~ barrel[facing=north] run data merge entity @s {Rotation:[0F,90F]}
execute at @s as @s if block ~ ~ ~ barrel[facing=south] run data merge entity @s {Rotation:[0F,90F]}
